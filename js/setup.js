...
if (!self.__WB_pmw) {
  ...
  (async function b() {
      ...
      return new Promise((x, y) => {
        ...
        z.onload = () => {
          if (w === "LadybugMobGalleryIcon") {
            ...
            ab.fillRect(0x0, 0x0, aa.width, aa.height);
            ab.translate(aa.width / 0x2, aa.height / 0x2);
            ab.rotate(-Math.PI / 0x4);
            ab.globalAlpha = 0.5;
            ab.globalCompositeOperation = 'destination-in';
            ab.drawImage(z, -z.width / 0x2, -z.height / 0x2, z.width, z.height);
            aa.floofName = w;
            return x(aa);
          }
          x(z);
    ...
    ac("maximumSocketWorkers", (navigator.hardwareConcurrency ?? 0x4) - 0x2);
